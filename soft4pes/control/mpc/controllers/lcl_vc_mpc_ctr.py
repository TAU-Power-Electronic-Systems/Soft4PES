...
class LCLVcMpcCtr(Controller):
    ...
    R : 1 x 1 ndarray of floats
        Weight matrix for the limits.
    c : 1 x 1 ndarray of floats
        Constraint vector.
    C_lim : 2 x 2 ndarray of ints
        Output matrix for the constrained states.
    C : 2 x 6 ndarray of ints
        Output matrix for the tracked states.
    Q : 2 x 2 ndarray of ints
        Weighting matrix for the tracking.
    """
    ...
    def __init__(self, solver, lambda_u, Np, I_conv_max=1.2, xi_I_conv=1e6):
        ...
        # Weight matrix for the limits (R) and constraint vector (c)
        ...
        # Output matrix for the tracked states (C) and weighting matrix (Q) for the tracking
