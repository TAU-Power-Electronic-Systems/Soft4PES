...
.. toctree::
   ...
   /autoapi/soft4pes/model/grid/l_filter_param/index
   /autoapi/soft4pes/model/grid/lcl_filter_param/index
   /autoapi/soft4pes/model/grid/rl_grid/index
   /autoapi/soft4pes/model/grid/rl_grid_l_filter/index
...
.. autoapisummary::
   ...
   soft4pes.model.grid.LFilterParameters
   soft4pes.model.grid.RLGridLFilter
...
.. py:class:: RLGridLFilter(par_grid, par_l_filter, conv, base, ig_ref_init=None)
   ...
   .. py:method:: get_pcc_voltage(kTs)
      ...
      :returns: Voltage at the point of common coupling (PCC).
      :rtype: 1 x 2 ndarray of floats
